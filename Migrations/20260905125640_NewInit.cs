        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClinicMode = table.Column<int>(type: "int", nullable: false),
                    EnableVitalWeight = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnableVitalBloodPressure = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnableVitalTemperature = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    EnableVitalHeartRate = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    UseProtocolNumber = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ProtocolEditableByNurse = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ProtocolEditableByDoctor = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProtocolNumber = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Anamneza = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Ekzaminimi = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "SuperAdmin", 0, null, "8f0e7d7e-a1c4-42c4-a7e5-6f0f1c1c6d8c", new DateTime(2026, 9, 5, 12, 56, 40, 367, DateTimeKind.Utc).AddTicks(8295), null, "superadmin@clinicops.local", true, true, false, null, "SUPERADMIN@CLINICOPS.LOCAL", "SUPERADMIN@CLINICOPS.LOCAL", "AQAAAAIAAYagAAAAEFYWdOuFh7PMUHUwaNj8k5Ka2tbyfo4a/htbHIw0lYe9ZmgjKgjE6RqjooKfKpLJyA==", null, false, "STATIC-SECURITY-STAMP", null, null, false, "superadmin@clinicops.local" });

            migrationBuilder.InsertData(
                table: "Clinics",
                columns: new[] { "Id", "Address", "ClinicMode", "ColorTheme", "CreatedAt", "Description", "EnableVitalBloodPressure", "EnableVitalHeartRate", "EnableVitalTemperature", "EnableVitalWeight", "IsActive", "LogoUrl", "Name", "Phone", "ProtocolEditableByDoctor", "ProtocolEditableByNurse", "UseProtocolNumber" },
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), "123 Test Street", 1, 0, new DateTime(2026, 9, 5, 12, 56, 40, 406, DateTimeKind.Utc).AddTicks(6423), null, true, true, true, true, true, null, "Default Test Clinic", "+1234567890", true, true, false });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientCases_ClinicId_ProtocolNumber",
                table: "PatientCases",
                columns: new[] { "ClinicId", "ProtocolNumber" },
                unique: true);
