...
namespace clinicops.Migrations
{
    ...
    [Migration("20260529044949_AssignedDoctorToPatientCase")]
    partial class AssignedDoctorToPatientCase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClinicOps.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "SuperAdmin",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5e19df84-db23-4827-ac01-e6bb9cb878f4",
                            CreatedAt = new DateTime(2026, 5, 29, 4, 49, 48, 909, DateTimeKind.Utc).AddTicks(8397),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELan/9MqnkZJIKua+hRtxFiJd+TzObGFF+g3itTscKtlzjWG+KV9FdhKpCbZqpyL1A==",
            ...
            modelBuilder.Entity("ClinicOps.Domain.Entities.Clinic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClinicMode = 1,
                            CreatedAt = new DateTime(2026, 5, 29, 4, 49, 48, 944, DateTimeKind.Utc).AddTicks(8362),
                            IsActive = true,
